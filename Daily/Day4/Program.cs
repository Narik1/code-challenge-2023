 ...
 *
 * Research how this language works and what each instruction does (>,<,[,],+,-,.).
 * Then use this information to make an interpreter that reads a brainfuck program from standard input and displays the result.
 *
 * Goblin mode:
...
using var codeStream = File.OpenRead("./code.bf");
